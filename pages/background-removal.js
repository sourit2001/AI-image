...
export default function BackgroundRemoval() {
  ...
  return (
    <>
      <Head>
        <title>{translate('backgroundRemovalTitle')} - {translate('title')}</title>
        <meta name="description" content={translate('backgroundRemovalDescription')} />
      </Head>
      ...
      <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-cyan-50">
        ...
        <main className="max-w-5xl mx-auto px-6 py-12">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold mb-4">{translate('backgroundRemovalTitle')}</h1>
            <p className="text-xl text-gray-600">{translate('backgroundRemovalDescription')}</p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <div className="mb-8 text-center">
              ...
              >
                {loading ? translate('processing') : translate('removeBackground')}
              </button>
            </div>
